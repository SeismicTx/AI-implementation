...
def parse_args():
    ...
    parser.add_argument('--output', required=False, help='Output processed CSV file')
...
def main():
    ...
    # Initialize processor with the directory containing the input file
    input_path = Path(args.input_dir)
    processor = AntibodyDataProcessor(input_path.parent)
